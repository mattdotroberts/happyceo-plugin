---
name: setup
description: Guided setup wizard — configure HappyCEO for your business. Connects your knowledge base, email, chat, and calendar. Trigger with "set up happyceo", "configure happyceo", "connect my tools", or "run setup".
---
