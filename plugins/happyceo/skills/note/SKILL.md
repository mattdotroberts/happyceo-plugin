---
name: note
description: Quick capture to inbox scratchpad. No thinking, just dump. Processed at end of day. Trigger with "quick note", "jot this down", "capture this", or "note: [text]".
---
